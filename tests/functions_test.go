...
func TestFunctions(t *testing.T) {
	...
	t.Run("Declare external function", func(t *testing.T) {
		...
		t.Run("Igbo", func(t *testing.T) {
			NewSuccessfulCompileRequest(t,
				"./functions/declaration.igbo.swa",
				"",
			)
		})
	})
	...
	t.Run("English", func(t *testing.T) {
		...
		t.Run("Substract", func(t *testing.T) {
			t.Run("Integer", func(t *testing.T) {
				...
				t.Run("Igbo", func(t *testing.T) {
					NewSuccessfulCompileRequest(t,
						"./functions/substract.integer.igbo.swa",
						"10 - 5 = 5",
					)
				})
			})
			...
			t.Run("Float", func(t *testing.T) {
				...
				t.Run("Igbo", func(t *testing.T) {
					NewSuccessfulCompileRequest(t,
						"./functions/substract.float.igbo.swa",
						"10.5 - 5.25 = 5.25",
					)
				})
			})
			...
			t.Run("DeepSeek Functions", func(t *testing.T) {
				t.Run("Basics", func(t *testing.T) {
					t.Run("Test 1: Simple function", func(t *testing.T) {
						...
						t.Run("Igbo", func(t *testing.T) {
							NewSuccessfulCompileRequest(t, "./functions/test1_simple_function_with_no_parameters_returning_int.igbo.swa", "one() = 1")
						})
					})
					t.Run("Test 2: One parameter", func(t *testing.T) {
						...
						t.Run("Igbo", func(t *testing.T) {
							NewSuccessfulCompileRequest(t, "./functions/test2_function_with_one_parameter_call_with_constant.igbo.swa", "double(5) = 10")
						})
					})
					t.Run("Test 3: Two parameters", func(t *testing.T) {
						...
						t.Run("Igbo", func(t *testing.T) {
							NewSuccessfulCompileRequest(t, "./functions/test3_function_with_two_parameters_call_with_variables.igbo.swa", "add(3,4) = 7")
						})
					})
					t.Run("Test 4: Return float", func(t *testing.T) {
						...
						t.Run("Igbo", func(t *testing.T) {
							NewSuccessfulCompileRequest(t, "./functions/test4_function_returning_float.igbo.swa", "pi() = 3.141590")
						})
					})
					t.Run("Test 5: Return string", func(t *testing.T) {
						...
						t.Run("Igbo", func(t *testing.T) {
							NewSuccessfulCompileRequest(t, "./functions/test5_function_returning_string.igbo.swa", "greet() = hello")
						})
					})
					t.Run("Test 6: Global side effect", func(t *testing.T) {
						...
						t.Run("Igbo", func(t *testing.T) {
							NewSuccessfulCompileRequest(t, "./functions/test6_function_with_side_effect_modifying_global.igbo.swa", "global = 42")
						})
					})
					t.Run("Test 8: Array as reference", func(t *testing.T) {
						...
						t.Run("Igbo", func(t *testing.T) {
							NewSuccessfulCompileRequest(t,
								"./functions/test8_function_that_takes_array_by_value_if_allowed_arrays_might_be_passed_by_reference_need_to_test.igbo.swa",
								"a[0] = 0")
						})
					})
				})
		...
		t.Run("Add", func(t *testing.T) {
			...
			t.Run("Integer", func(t *testing.T) {
				...
				t.Run("Igbo", func(t *testing.T) {
					NewSuccessfulCompileRequest(t,
						"./functions/add.integer.igbo.swa",
						"10 + 5 = 15",
					)
				})
			})
		...
		t.Run("Divide", func(t *testing.T) {
			t.Run("Integer", func(t *testing.T) {
				...
				t.Run("Igbo", func(t *testing.T) {
					NewSuccessfulCompileRequest(t,
						"./functions/divide.integer.igbo.swa",
						"10 / 5 = 2",
					)
				})
			})
			...
			t.Run("Float", func(t *testing.T) {
				...
				t.Run("Igbo", func(t *testing.T) {
					NewSuccessfulCompileRequest(t,
						"./functions/divide.float.igbo.swa",
						"10.0 / 5.0 = 2.000000",
					)
				})
			})
		...
		t.Run("Multiply", func(t *testing.T) {
			t.Run("Float", func(t *testing.T) {
				...
				t.Run("Igbo", func(t *testing.T) {
					NewSuccessfulCompileRequest(t,
						"./functions/multiply.float.igbo.swa",
						"10.02, 5.05 = 50.601000",
					)
				})
			})
			...
			t.Run("Integer", func(t *testing.T) {
				...
				t.Run("Igbo", func(t *testing.T) {
					NewSuccessfulCompileRequest(t,
						"./functions/multiply.integer.igbo.swa",
						"10 * 5 = 50",
					)
				})
			})
	...
	t.Run("DeepSeek Functions", func(t *testing.T) {
		...
		t.Run("Recursion", func(t *testing.T) {
			t.Run("Test 20: Side effect", func(t *testing.T) {
				...
				t.Run("Igbo", func(t *testing.T) {
					NewSuccessfulCompileRequest(t,
						"./functions/test20_function_call_with_side_effects_in_arguments_order_of_evaluation.igbo.swa",
						"side_effect 1 called (order=1)side_effect 2 called (order=2)result = 3")
				})
			})
			...
			t.Run("Test 11: Factorial", func(t *testing.T) {
				...
				t.Run("Igbo", func(t *testing.T) {
					NewSuccessfulCompileRequest(t,
						"./functions/test11_recursion_factorial.igbo.swa", "5! = 120")
				})
			})
			//	FIXME
			...
			t.Run("Test 27: Direct recursion", func(t *testing.T) {
				...
				t.Run("Igbo", func(t *testing.T) {
					NewSuccessfulCompileRequest(t,
						"./functions/test27_function_call_inside_its_own_definition_direct_recursion_already_tested_but_add_a_simple_one.igbo.swa",
						"5 4 3 2 1 0")
				})
			})
		})
		...
		t.Run("Composition and Arguments", func(t *testing.T) {
			t.Run("Test 13: Expression arguments", func(t *testing.T) {
				...
				t.Run("Igbo", func(t *testing.T) {
					NewSuccessfulCompileRequest(t, "./functions/test13_function_call_with_expression_arguments.igbo.swa", "add(2*2, 3+1) = 8")
				})
			})
			t.Run("Test 14: Nested calls", func(t *testing.T) {
				...
				t.Run("Igbo", func(t *testing.T) {
					NewSuccessfulCompileRequest(t, "./functions/test14_nested_function_calls_composition.igbo.swa", "twice(square(3)) = 18")
				})
			})
			t.Run("Test 17: Many parameters", func(t *testing.T) {
				...
				t.Run("Igbo", func(t *testing.T) {
					NewSuccessfulCompileRequest(t,
						"./functions/test17_function_with_many_parameters_stress.igbo.swa",
						"sum10 = 55")
				})
			})
		})
		...
		t.Run("Structs and Arrays", func(t *testing.T) {
			t.Run("Test 15: Return struct", func(t *testing.T) {
				...
				t.Run("Igbo", func(t *testing.T) {
					NewFailedCompileRequest(t,
						"./functions/test15_function_returning_a_struct.igbo.swa",
						"returning complex types (structs and arrays) from functions is currently not supported\n")
				})
			})
			t.Run("Test 36: Return struct with array", func(t *testing.T) {
				...
				t.Run("Igbo", func(t *testing.T) {
					NewFailedCompileRequest(t,
						"./functions/test36_function_that_returns_a_struct_containing_an_array.igbo.swa",
						"returning complex types (structs and arrays) from functions is currently not supported\n")
				})
			})
		})
		...
		t.Run("Control Flow and Side Effects", func(t *testing.T) {
			t.Run("Test 7: Call by value", func(t *testing.T) {
				...
				t.Run("Igbo", func(t *testing.T) {
					NewSuccessfulCompileRequest(t,
						"./functions/test7_function_that_modifies_parameter_call_by_value_should_not_affect_caller.igbo.swa",
						"a = 5")
				})
			})
			...
			t.Run("Test 39: Call in loop", func(t *testing.T) {
				...
				t.Run("Igbo", func(t *testing.T) {
					NewSuccessfulCompileRequest(t,
						"./functions/test39_function_call_inside_a_loop.igbo.swa", "i=0\ni=1\ni=2\ni=3\ni=4\n")
				})
			})
			t.Run("Test 40: Dual side effects", func(t *testing.T) {
				...
				t.Run("Igbo", func(t *testing.T) {
					NewSuccessfulCompileRequest(t,
						"./functions/test40_function_call_with_side_effect_that_modifies_global_used_in_argument.igbo.swa",
						"r = 3, g = 2")
				})
			})
		...
		t.Run("Initializers", func(t *testing.T) {
			t.Run("Test 49: Call in struct init", func(t *testing.T) {
				...
				t.Run("Igbo", func(t *testing.T) {
					NewSuccessfulCompileRequest(t, "./functions/test49_function_call_inside_struct_literal_initialization.igbo.swa", "w.val = 42")
				})
			})
			t.Run("Test 50: Call in array init", func(t *testing.T) {
				...
				t.Run("Igbo", func(t *testing.T) {
					NewSuccessfulCompileRequest(t, "./functions/test50_function_call_in_array_initializer.igbo.swa", "arr[0] = 0\narr[1] = 1\narr[2] = 4\narr[3] = 9\narr[4] = 16\n")
				})
			})
		})
		...
		t.Run("Expected Failures", func(t *testing.T) {
			...
			t.Run("Test 25: Missing return", func(t *testing.T) {
				...
				t.Run("Igbo", func(t *testing.T) {
					NewFailedCompileRequest(t, "./functions/test25_function_with_missing_return_statement_should_not_compile.igbo.swa", "function has no return statement\n")
				})
			})
