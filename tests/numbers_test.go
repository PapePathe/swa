...
func TestIntegerArithmetic(t *testing.T) {
	t.Run("01", func(t *testing.T) {
		...
		t.Run("Igbo", func(t *testing.T) {
			NewSuccessfulCompileRequest(t,
				"./numbers/integer-arithmetic/01.igbo.swa", "5 + 3 = 8",
				OptCompileNative)
		})
	})
	t.Run("02", func(t *testing.T) {
		...
		t.Run("Igbo", func(t *testing.T) {
			NewSuccessfulCompileRequest(t,
				"./numbers/integer-arithmetic/02.igbo.swa", "10 - 4 = 6", OptCompileNative)
		})
	})
	t.Run("03", func(t *testing.T) {
		...
		t.Run("Igbo", func(t *testing.T) {
			NewSuccessfulCompileRequest(t,
				"./numbers/integer-arithmetic/03.igbo.swa", "7 * 6 = 42", OptCompileNative)
		})
	})
	t.Run("04", func(t *testing.T) {
		...
		t.Run("Igbo", func(t *testing.T) {
			NewSuccessfulCompileRequest(t,
				"./numbers/integer-arithmetic/04.igbo.swa", "15 / 4 = 3", OptCompileNative)
		})
	})
	...
	t.Run("07", func(t *testing.T) {
		...
		t.Run("Igbo", func(t *testing.T) {
			NewSuccessfulCompileRequest(t,
				"./numbers/integer-arithmetic/07.igbo.swa", "10 - 3 - 2 = 5", OptCompileNative)
		})
	})
	t.Run("08", func(t *testing.T) {
		...
		t.Run("Igbo", func(t *testing.T) {
			NewSuccessfulCompileRequest(t,
				"./numbers/integer-arithmetic/08.igbo.swa", "16 / 4 / 2 = 2", OptCompileNative)
		})
	})
	t.Run("09", func(t *testing.T) {
		...
		t.Run("Igbo", func(t *testing.T) {
			NewSuccessfulCompileRequest(t,
				"./numbers/integer-arithmetic/09.igbo.swa", "5 + 3 * 2 - 8 / 4 = 9", OptCompileNative)
		})
	})
	...
	t.Run("21", func(t *testing.T) {
		...
		t.Run("Igbo", func(t *testing.T) {
			NewSuccessfulCompileRequest(t,
				"./numbers/integer-arithmetic/21.igbo.swa", "-(-5) = 5", OptCompileNative)
		})
	})
	t.Run("22", func(t *testing.T) {
		...
		t.Run("Igbo", func(t *testing.T) {
			NewSuccessfulCompileRequest(t,
				"./numbers/integer-arithmetic/22.igbo.swa", "-x (x=7) = -7", OptCompileNative)
		})
	})
	t.Run("23", func(t *testing.T) {
		...
		t.Run("Igbo", func(t *testing.T) {
			NewSuccessfulCompileRequest(t,
				"./numbers/integer-arithmetic/23.igbo.swa", "-17 % 5 = -2", OptCompileNative)
		})
	})
	t.Run("24", func(t *testing.T) {
		...
		t.Run("Igbo", func(t *testing.T) {
			NewSuccessfulCompileRequest(t,
				"./numbers/integer-arithmetic/24.igbo.swa", "7 / 2 = 3", OptCompileNative)
		})
	})
	t.Run("25", func(t *testing.T) {
		...
		t.Run("Igbo", func(t *testing.T) {
			NewSuccessfulCompileRequest(t,
				"./numbers/integer-arithmetic/25.igbo.swa", "-7 / 2 = -3", OptCompileNative)
		})
	})
	...
	t.Run("27", func(t *testing.T) {
		...
		t.Run("Igbo", func(t *testing.T) {
			NewSuccessfulCompileRequest(t,
				"./numbers/integer-arithmetic/27.igbo.swa", "-7 / -2 = 3", OptCompileNative)
		})
	})
	...
	t.Run("28", func(t *testing.T) {
		...
		t.Run("Igbo", func(t *testing.T) {
			NewSuccessfulCompileRequest(t,
				"./numbers/integer-arithmetic/28.igbo.swa",
				"2 + 3*4 - (6/2) + -5%3 = 9", OptCompileNative)
		})
	})
...
func TestNumberZeroValues(t *testing.T) {
	t.Run("Float", func(t *testing.T) {
		...
		t.Run("Igbo", func(t *testing.T) {
			NewSuccessfulCompileRequest(t,
				"./numbers/zero-values/float.igbo.swa",
				"zero value: 0.000000 assigned value: 100.000000",
				//				OptCompileNative,
			)
		})
	...
	t.Run("Int", func(t *testing.T) {
		...
		t.Run("Igbo", func(t *testing.T) {
			NewSuccessfulCompileRequest(t,
				"./numbers/zero-values/int.igbo.swa",
				"zero value: 0 assigned value: 100",
				OptCompileNative,
			)
		})
...
func TestSignedNumbers(t *testing.T) {
	t.Run("English", func(t *testing.T) {
		...
		t.Run("integer arithmetic igbo", func(t *testing.T) {
			NewSuccessfulCompileRequest(t,
				"./numbers/integer-arithmetic/source.igbo.swa",
				"okokokokokok",
			)
		})
		...
		t.Run("integer-arrays igbo", func(t *testing.T) {
			NewSuccessfulCompileRequest(t,
				"./numbers/integer-arrays/source.igbo.swa",
				"okokok",
			)
		})
		...
		t.Run("integer-float-separation igbo", func(t *testing.T) {
			NewSuccessfulCompileRequest(t,
				"./numbers/integer-float-separation/source.igbo.swa",
				"",
			)
		})
	})
